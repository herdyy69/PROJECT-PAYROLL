            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group">
                    <label for="nama_karyawan" class="col-form-label">JENIS JABATAN</label>
                    <input type="text" name="nama_karyawan" value="{{ $jabatan->nama_karyawan }}" class="form-control @error('nama_karyawan') is-invalid @enderror" id="nama_karyawan" >
                                    @error('nama_karyawan')
